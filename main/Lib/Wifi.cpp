...
static void InitSoftAP()
{
	...
	Secrets::kSoftAP_ssid.copy((char*)ap->ssid, Secrets::kSoftAP_ssid.size());
	Secrets::kSoftAP_password.copy((char*)ap->password, Secrets::kSoftAP_password.size());
...
{
	mdns_init();
	mdns_hostname_set("Espresso-Scales");
	mdns_instance_name_set("Espresso-Scales");

	mdns_txt_item_t serviceTxtData[] = { };

	ESP_ERROR_CHECK(mdns_service_add("SCALES", "_http", "_tcp", 80, serviceTxtData,
